...
//   try {
//     const dataverseResponse = await axios.get(
...
//     res.json({
//       dataverseSearch: dataverseResponse.data,
//       datasetSearch: datasetResponse.data,
//       fileSearch: fileResponse.data,
//       rootDataverse: rootResponse.data,
//     });
//   } catch (error) {
